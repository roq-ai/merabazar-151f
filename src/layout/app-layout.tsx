...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['property-seller', 'real-estate-agent', 'property-inspector', 'customer-support-representative'];
  ...
  const { data, error, isLoading } = useSWR<BrokerageInterface[]>(
    ...
    () => getBrokerages({ tenant_id: session?.user?.tenantId }).then(({ data }) => data),
  );
  loading = isLoading;
